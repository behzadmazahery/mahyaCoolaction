...
const BestSelerSlider = () => {
    ...
    // bestSelerData.sort((a, b) => a.rating - b.rating);
    // bestSelerData.sort((a, b) => new Date(a.date) - new Date(b.date));

    return (
        <div className='bestSeler__box' >
            <Title title="پرفروش ترین محصولات " route="/ProductPage" />
            <>
                <Swiper
                    slidesPerView={4}
                    spaceBetween={30}
...
export default BestSelerSlider
